...
export type Note = {
	midi: MidiValue 			// midi of type MidiValue - a number in Octave Notation
	type: NoteType				// type of type NoteType - which note it is: natural or sharp
	pitch: NotePitch      // pitch of type NotePitch - a literal representation of a note’s pitch
	index: PitchIndex			// index of type PitchIndex - an index of notes in an octave
	octave: OctaveIndex		// octave of type OctaveIndex - an octave index of a given note
}
...
export const PITCHES_REGISTRY: Record<PitchIndex, NotePitch> = { 0: "C", 1: "C", 2: "D", 3: "D", 4: "E", 5: "F", 6: "F", 7: "G", 8: "G", 9: "A", 10: "A", 11: "B" }
